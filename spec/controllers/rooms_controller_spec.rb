...
describe RoomsController do
  ...
  let(:valid_attributes) {{:title => "This is a test title", :description => "this is a test description"} }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved room as @room" do
        ...
        post :create, {:room => {:title => "this is a title", :description => "this is a desc"}}, valid_session
        assigns(:room).should be_a_new(Room)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested room" do
        ...
        Room.any_instance.should_receive(:update).with({ "title" => "new title" })
        put :update, {:id => room.to_param, :room => { "title" => "new title" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the room as @room" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Room.any_instance.stub(:save).and_return(false)
        put :update, {:id => room.to_param, :room => {"description" => "new title" }}, valid_session
        assigns(:room).should eq(room)
      end
